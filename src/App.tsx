      ...
      <div className={`page ${isLoading ? "page--loading" : "page--ready"}`}>
        <header className="nav">
          ...
          <div className="nav__social">
            <a href="/Kartik.Pagey_Resume" download="Kartik.Pagey_Resume.pdf" className="nav__resume">Download Resume</a>
        ...
        <footer id="contact" className="footer">
          <div className="footer__content">
            <div className="footer__links">
              ...
              <a href="#certs">Certifications & Achievements</a>
              <a href="#education">Education</a>
              <a href="/Kartik.Pagey_Resume" download="Kartik.Pagey_Resume.pdf">Download Resume</a>
            </div>
